...
import 'package:unbaja_parking_app/app/modules/data_admin/controllers/data_admin_controller.dart';
...
class DataAdminDetailView extends GetView<DataAdminController> {
  const DataAdminDetailView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('DataAdminDetailView'),
        centerTitle: true,
      ),
      body: FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        future: controller.getDataAdmin(Get.arguments),
