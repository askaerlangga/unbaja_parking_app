...
import 'package:unbaja_parking_app/app/modules/data_petugas/controllers/data_petugas_controller.dart';
...
class DataPetugasDetailView extends GetView<DataPetugasController> {
  const DataPetugasDetailView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Data Petugas Detail'),
        centerTitle: true,
      ),
      body: FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        future: controller.getDataPetugas(Get.arguments),
